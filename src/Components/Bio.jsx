function Bio() {
  return (
    <div className="w-1/4 mx-auto mb-10">
      ...
      <p className="mb-2">
        &nbsp; Hi, i'm Alessio a 20 years old tech nerd &#129299;. <br />
        I'm a fullstack, details oriented, software developer with a passion for
        building catchy, minimal website and robust back-end logic &#9881;.{" "}
        <br />
